...
class AccountApi:
    ...
    def api_v1_account_get(
        ...
        _param = self._api_v1_account_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiV1AccountGet200Response",
            '401': "Error",
            '403': "Error",
        }
    ...
    @validate_call
    def api_v1_account_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiV1AccountGet200Response]:
        """Identity check — returns the authenticated user + scopes of the calling key.
    ...
    @validate_call
    def api_v1_account_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _api_v1_account_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
