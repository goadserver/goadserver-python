...
class ResourceFilter(BaseModel):
    ...
    """ # noqa: E501
    campaign_ids: Optional[List[StrictInt]] = None
    adzone_ids: Optional[List[StrictInt]] = None
    site_ids: Optional[List[StrictInt]] = None
    creative_ids: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["campaign_ids", "adzone_ids", "site_ids", "creative_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "adzone_ids": obj.get("adzone_ids"),
            "site_ids": obj.get("site_ids"),
            "creative_ids": obj.get("creative_ids")
        })
        return _obj
