...
class ApiV1FiltersTypeIdItemsPost200Response(BaseModel):
    """
    ...
    added: Optional[List[StrictStr]] = Field(default=None, description="The IDs/strings actually added (post resolution + dedupe).")
    __properties: ClassVar[List[str]] = ["id", "type", "items", "item_count", "added"]
