...
class ApiV1AccountGet200Response(BaseModel):
    """
    ApiV1AccountGet200Response
    """ # noqa: E501
    user_id: Optional[StrictInt] = None
    system_id: Optional[StrictInt] = None
    email: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    company: Optional[StrictStr] = None
    api_key: Optional[ApiV1AccountGet200ResponseApiKey] = None
    __properties: ClassVar[List[str]] = ["user_id", "system_id", "email", "name", "company", "api_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "api_key": ApiV1AccountGet200ResponseApiKey.from_dict(obj["api_key"]) if obj.get("api_key") is not None else None
        })
        return _obj
