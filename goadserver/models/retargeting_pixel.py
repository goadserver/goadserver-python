...
class RetargetingPixel(BaseModel):
    """
    RetargetingPixel
    """ # noqa: E501
    ...
    visitors: Optional[StrictInt] = Field(default=None, description="Captured visitor count from ClickHouse.")
    __properties: ClassVar[List[str]] = ["id", "name", "is_active", "visitors"]
