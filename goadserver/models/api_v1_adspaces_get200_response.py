...
class ApiV1AdspacesGet200Response(BaseModel):
    """
    ApiV1AdspacesGet200Response
    """ # noqa: E501
    data: Optional[List[ApiV1AdspacesGet200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ApiV1AdspacesGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "page": obj.get("page"),
