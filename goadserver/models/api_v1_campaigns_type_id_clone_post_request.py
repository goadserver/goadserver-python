...
class ApiV1CampaignsTypeIdClonePostRequest(BaseModel):
    """
    ApiV1CampaignsTypeIdClonePostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Override the cloned campaign's name. Defaults to \"<original> Copy\".")
