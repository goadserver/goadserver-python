...
class ApiV1CampaignsTypeSchemaAdsGet200Response(BaseModel):
    """
    ApiV1CampaignsTypeSchemaAdsGet200Response
    """ # noqa: E501
    campaign_type: Optional[StrictStr] = None
    campaign_ad_type: Optional[StrictInt] = Field(default=None, description="0 if not scoped to a campaign.")
    fields: Optional[List[Dict[str, Any]]] = None
    creative_choice: Optional[List[StrictStr]] = None
    notes: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["campaign_type", "campaign_ad_type", "fields", "creative_choice", "notes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "campaign_ad_type": obj.get("campaign_ad_type"),
            "fields": obj.get("fields"),
            "creative_choice": obj.get("creative_choice"),
            "notes": obj.get("notes")
        })
        return _obj
