...
class ApiV1CampaignsTypeIdFiltersPostRequest(BaseModel):
    """
    ...
    def filter_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['domain_excl', 'adzone_excl', 'isp_excl', 'subid_excl', 'domain_incl', 'adzone_incl', 'subid_incl']):
            raise ValueError("must be one of enum values ('domain_excl', 'adzone_excl', 'isp_excl', 'subid_excl', 'domain_incl', 'adzone_incl', 'subid_incl')")
        return value
