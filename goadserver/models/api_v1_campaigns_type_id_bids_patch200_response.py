...
class ApiV1CampaignsTypeIdBidsPatch200Response(BaseModel):
    """
    ApiV1CampaignsTypeIdBidsPatch200Response
    """ # noqa: E501
    updated: Optional[StrictInt] = Field(default=None, description="How many ads were actually updated.")
    ad_ids: Optional[List[StrictInt]] = None
    mode: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["updated", "ad_ids", "mode"]
