...
class ApiV1CampaignsGet200ResponseDataInner(BaseModel):
    """
    ...
    selling_type: Optional[StrictInt] = None
    is_paused: Optional[StrictBool] = None
    is_active: Optional[StrictBool] = None
    is_deleted: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "name", "campaign_type", "ad_type", "selling_type", "is_paused", "is_active", "is_deleted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selling_type": obj.get("selling_type"),
