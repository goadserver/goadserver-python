...
class ApiV1TrackingPixelsGet200Response(BaseModel):
    """
    ApiV1TrackingPixelsGet200Response
    """ # noqa: E501
    data: Optional[List[TrackingPixel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [TrackingPixel.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "page": obj.get("page"),
