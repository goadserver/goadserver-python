...
class ApiV1CampaignsTypeIdMinBidGet200Response(BaseModel):
    """
    ApiV1CampaignsTypeIdMinBidGet200Response
    """ # noqa: E501
    campaigns: Optional[StrictStr] = Field(default=None, description="Minimum bid as a fixed-decimal string (legacy panel format).")
