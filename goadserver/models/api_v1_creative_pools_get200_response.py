...
class ApiV1CreativePoolsGet200Response(BaseModel):
    """
    ApiV1CreativePoolsGet200Response
    """ # noqa: E501
    data: Optional[List[ApiV1CreativePoolsGet200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ApiV1CreativePoolsGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total")
        })
        return _obj
