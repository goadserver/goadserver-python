...
class TestApiKeyDetailsCreated(unittest.TestCase):
    """ApiKeyDetailsCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKeyDetailsCreated:
        """Test ApiKeyDetailsCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKeyDetailsCreated`
        """
        model = ApiKeyDetailsCreated()
        if include_optional:
            return ApiKeyDetailsCreated(
                id = 56,
                name = '',
    ...
    def testApiKeyDetailsCreated(self):
        """Test ApiKeyDetailsCreated"""
