...
from goadserver.api.adspaces_api import AdspacesApi


class TestAdspacesApi(unittest.TestCase):
    """AdspacesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AdspacesApi()

    def tearDown(self) -> None:
        pass

    def test_api_v1_adspaces_get(self) -> None:
        """Test case for api_v1_adspaces_get
